...
<template>
  ...
  >
    ...
    <BaseKbd>
      <span class="text-xs">{{ metaSymbol }}</span
      >K
    </BaseKbd>
  </Button>
  ...
  <CommandDialog v-model:open="openCommand">
    ...
    <CommandList>
      ...
      <CommandGroup heading="Suggestions">
        ...
        <CommandItem value="prodcuts" @select="handleSelectLink('/products')">
          Products
          <CommandShortcut>
            <BaseKbd>G</BaseKbd>
            <BaseKbd>P</BaseKbd>
        ...
        <CommandItem
          value="categories"
          @select="handleSelectLink('/categories')"
        >
          Categories
          <CommandShortcut>
            <BaseKbd>G</BaseKbd>
        ...
        <CommandItem value="account" @select="handleSelectLink('/account')">
          Account
          <CommandShortcut>
            <BaseKbd>G</BaseKbd>
            <BaseKbd>A</BaseKbd>
